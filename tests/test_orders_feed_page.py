...
class TestOrdersFeedPage:
    ...
    def test_change_all_orders_count(self, driver, test_credentials):
    ...
    def test_change_today_orders_count(self, driver, test_credentials):
        orders_feed_page = OrdersFeedPage(driver)
        main_page = MainPage(driver)
        main_page.open_page()
        main_page.make_login(test_credentials)
    ...
    def test_order_in_progress(self, driver, test_credentials):
        orders_feed_page = OrdersFeedPage(driver)
        main_page = MainPage(driver)
        main_page.open_page()
        main_page.make_login(test_credentials)
